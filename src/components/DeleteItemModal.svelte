...
<div class="modal-box bg-gradient-to-b from-gray-800 to-gray-950">
	...
	<form method="dialog" class="flex gap-4">
		<button class="btn btn-primary bg-red-500 text-white hover:text-white hover:bg-red-800 rounded-lg cursor-pointer border-none text-md" type="submit" on:click={callback}>Delete</button>
